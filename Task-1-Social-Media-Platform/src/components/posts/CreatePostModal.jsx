...
import { Image, Smile, MapPin, X, Sparkles, Upload } from 'lucide-react';
...
export default function CreatePostModal({ isOpen, onClose }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Create New Post" maxWidth="560px">
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        <textarea
          ...
          placeholder={`Share what you are designing, building, or learning today...`}
          rows={4}
          style={{
            width: '100%',
            resize: 'none',
        ...
        {showPresets && (
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: '0.8rem', fontWeight: 600 }}>Choose from Showcase Photos</span>
        ...
        <input
          ...
          placeholder="Add tags separated by space (e.g. #WebDev #React)"
